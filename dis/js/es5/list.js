...
$(function () {
    ...
    $('.search_lt ul li>em').click(function () {
        ...
        if (isok == 'true') {
            ...
            $(this).css('background', 'url(../img/banggo_jn.png) no-repeat 0px -90px');
            //改变自定义属性值
            $(this).attr('data-isok', 'false');
        } else {
            $(this).parent().find('dl').css('display', 'none');
            $(this).next().css('text-decoration', 'none');
            $(this).css('background', 'url(../img/banggo_jn.png) no-repeat -9px -90px');
    ...
    $('.search_lt ul li dl dt em').click(function () {
        ...
        if (isok == 'true') {
            ...
            $(this).css('background', 'url(../img/banggo_jn.png) no-repeat -17px -90px');
            $(this).attr('data-isok', 'false');
        } else {
            ...
            $(this).css('background', 'url(../img/banggo_jn.png) no-repeat -25px -90px');
            $(this).attr('data-isok', 'true');
        }
    });
